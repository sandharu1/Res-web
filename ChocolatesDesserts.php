              ...
              <div class="container">
                ...
                <li class="active dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="ChocolatesDesserts.php">Chocolates & Desserts</a></li>
...
<div class="container style-row">
    <h2 class="text-center text-warning"><Strong><u>Chocolates & Desserts</u></Strong></h2>
    <br>
    <br>
    <!-- =======pop out cart======= -->
    <!-- View Cart Box Start -->
...
<div class="row">
    <?php
    $results = $conn->query("SELECT * FROM products WHERE item_type='ChocolatesDesserts'");
